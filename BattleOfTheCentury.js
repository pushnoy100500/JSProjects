...
function ronaldPunch() {
	var userChoise = prompt("Hey Ronald! Punch him!!! \(enter number 1 to 4\)");
	var chance = getRandom(1, 4);
	
	if(userChoise == chance) {
		return 2;
	} else {
		return 0;
	}
...
function joePunch() {
	var userChoise = prompt("Kick his **s Joe! \(enter number 1 to 2\)");
		var chance = getRandom(1, 2);
	if(userChoise == chance) {
		return 1;
	} else {
		return 0;
